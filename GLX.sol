...
/**
#GalaxyCoin $GLX 🚀Fair Launch🚀 soon on August 7th, at 2PM UTC.
...
contract GalaxyCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address public constant TEAM_ADDRESS =
        0x8AfA41211625A4ccE5f1174c77dF2bEafCb882cf;
    ...
    string private _name = "Galaxy Coin";
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "GLX::transfer: Mkt value invalid"
            );
